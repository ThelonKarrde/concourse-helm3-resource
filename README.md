...
[github packages]: https://github.com/ThelonKarrde/concourse-helm3-resource/pkgs/container/concourse-helm3-resource
...
- name: helm
  type: docker-image
  source:
    repository: ghcr.io/ThelonKarrde/concourse-helm3-resource
```
